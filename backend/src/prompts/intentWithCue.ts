...
- This structured summary is your PRIMARY source for extraction, provided in the LAST assistant message. The strict word order makes extraction deterministic — parse left to right.
...
🛑 POTENCY WORDS ARE NOT EFFECTS — they do NOT trigger type inference:
strong, potent, powerful, very strong, most potent, strongest, mild, milder, weak, high THC, highest THC, maximum strength
"most potent prerolls" → NO type inference. "potent" is potency, not an effect.
"very strong vapes" → NO type inference. Only add type when an EFFECT word from the lists above is present.
...
- When extracting effects, ALWAYS map to canonical effects using the mapping below:
  ...
  **Effects Mapping (phrase → canonical effect):**
  ...
  - Energy-related: "energizing", "energized", "energy", "awake", "alert" → "energetic"
  - Uplift-related: "uplifting", "uplift", "elevated" → "uplifted" | 🚨 "uplifting" MUST map to "uplifted" — do not return "uplifting" in the effects array
